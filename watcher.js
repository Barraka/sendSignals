...
5. After posting, log the signal TWO ways:
   a) Append to /home/manu/.openclaw/workspace/memory/trading/signals/${new Date().toISOString().slice(0, 10)}.jsonl: {"time":"${jsonData.time}","symbol":"${jsonData.symbol}","direction":"${jsonData.direction}","score":N,"verdict":"GO|CAUTION|SKIP","setup":"type","reason":"one-line summary","review":"2-3 sentence analysis: what you see on the chart, why this score, key risk or opportunity. This goes in the Google Sheet as Kit Review."}
